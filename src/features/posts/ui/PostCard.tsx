    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
      <div className="flex flex-col sm:flex-row gap-4 p-4 sm:p-5">
        ...
        <div className="relative flex-shrink-0 w-full sm:w-[200px]">
          <div className="w-full min-h-[140px] rounded-lg overflow-hidden flex items-center justify-center">
            <ImageZoom
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100 mt-auto">
            <div className="flex items-center space-x-2">
              ...
              <Button variant="ghost" size="sm" className="h-9 px-3 text-gray-600 cursor-default pointer-events-none">
                <MessageCircle className="w-4 h-4 mr-2" />
                <span className="text-sm font-medium">Comments ({totalComments})</span>
              </Button>
              <Button
                variant="ghost"
                size="sm"
